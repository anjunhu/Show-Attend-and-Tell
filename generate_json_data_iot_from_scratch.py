...
def generate_json_data(split_path, data_path, max_captions_per_image, min_word_count):
    ...
    for split in ['test', 'train']:
        ...
        for img in annotations['images']:
            ...
            for sentence in img['sentences']:
                ...
                # sentence['tokens'] = cleaned_tokens
    ...
    with open('data/iot/word_dict_iot.json', 'w') as f:
    ...
    with open('./data/iot/train_img_paths.json', 'w') as f:
        json.dump(train_img_paths, f)
    with open('./data/iot/val_img_paths.json', 'w') as f:
        json.dump(validation_img_paths, f)
    with open('./data/iot/train_captions.json', 'w') as f:
        json.dump(train_captions, f)
    with open('./data/iot/val_captions.json', 'w') as f:
